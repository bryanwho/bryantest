			...
			menu: [
                    ...
                    onclick: function() {
                        editor.windowManager.open( {
                            title: 'Insert about me box Shortcode',
                            body: [{
                                type: 'textbox',
                                name: 'num',
                                label: 'How many about me posts to show?',
								tooltip: 'This is how many about me posts will be displayed.'
                                ...
                                type: 'listbox',
                                name: 'smooth',
								tooltip: 'Enable or disable smooth height.',
                            ...
                            onsubmit: function( e ) {
                                editor.insertContent( '[aboutme num="' + e.data.num + '" effect="' + e.data.effect + '" smooth="' + e.data.smooth + '" custom_class="' + e.data.clas + '"]');
                            }
                        });
                    }
                },
			...
			// Post grid
                    ...
                    onclick: function() {
                        editor.windowManager.open( {
                            ...
                            onsubmit: function( e ) {
                                editor.insertContent( '[posts_grid type="' + e.data.type + '" category="' + e.data.cat + '" columns="' + e.data.num + '" rows="' + e.data.rows + '" order_by="' + e.data.orderby + '" order="' + e.data.order + '" thumb_width="' + e.data.width + '" thumb_height="' + e.data.height + '" meta="' + e.data.meta + '" isdate="' + e.data.date + '" excerpt_count="' + e.data.excerpt + '" link="' + e.data.link + '" link_text="' + e.data.linktxt + '" custom_class="' + e.data.classc + '"]');
                            }
                        });
                    }
                },
