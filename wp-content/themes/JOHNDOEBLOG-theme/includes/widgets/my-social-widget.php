		...
		?>
			...
			<?php foreach(array("Facebook", "Twitter", "Flickr", "Linkedin", "Dribbble", "Deviantart", "Pinterest", "Vimeo", "Gplus", "Instagram", "Aim", "Youtube", "Rss", "Goodreads") as $network) : ?>
	    		<?php if (!empty($networks[$network]['link'])) : ?>
					...
					<?php if ($display == "both") { ?>
						<a class="icon-<?php echo strtolower($network);?> icon-2x social_link social_link__<?php echo strtolower($network); ?>" data-rel="tooltip" data-original-title="<?php echo strtolower($network); ?>" href="<?php echo $networks[$network]['link']; ?>">
					...
					<?php if ($display == "icons") { ?>
						...
						<a class="social_link social_link__<?php echo strtolower($network); ?>" data-rel="tooltip" data-original-title="<?php echo strtolower($network); ?>" href="<?php echo $networks[$network]['link']; ?>">
