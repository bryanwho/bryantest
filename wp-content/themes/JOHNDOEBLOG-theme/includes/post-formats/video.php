...
<?php
	        ...
	        //Display Vimeo video
	        echo '<iframe src="http://player.vimeo.com/video/'.$video_id.'?title=0&amp;byline=0&amp;portrait=0" width="'.$blog_thumb_width.'" height="'.$blog_thumb_height.'" frameborder="0"></iframe>';
	        ...
	        echo '<iframe title="YouTube video player" class="youtube-player" type="text/html" width="'.$blog_thumb_width.'" height="'.$blog_thumb_height.'" src="http://www.youtube.com/embed/'.$video_id.'?wmode=opaque" frameborder="0"></iframe>';
...
<?php $blog_thumb_width = of_get_option('blog_thumb_width');
