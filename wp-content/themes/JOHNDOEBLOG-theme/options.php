...
if(!function_exists('optionsframework_options')) {
	...
	//yes/no array
		...
		$options['google_mixed_3'] = array( 'name' => 'Body Text',
							...
							'id' => 'google_mixed_3',
							'std' => array( 'size' => '16px', 'lineheight' => '31px', 'face' => 'Open Sans', 'style' => 'normal', 'weight' => '300', 'character'  => 'latin', 'color' => '#525252'),
							'type' => 'typography',
							'options' => array(
		...
		$options['h1_heading'] = array( 'name' => 'H1 Heading',
							...
							'id' => 'h1_heading',
							'std' => array( 'size' => '43px', 'lineheight' => '43px', 'face' => 'Oswald', 'style' => 'normal', 'weight' => '300',  'character'  => 'latin', 'color' => '#222222'),
							'type' => 'typography',
							'options' => array(
									'faces' => $hs_typography_mixed_fonts )
							);
		...
		$options['h2_heading'] = array( 'name' => 'H2 Heading',
							...
							'id' => 'h2_heading',
							'std' => array( 'size' => '40px', 'lineheight' => '40px', 'face' => 'Oswald', 'style' => 'normal', 'weight' => '300', 'character'  => 'latin', 'color' => '#222222'),
							'type' => 'typography',
							'options' => array(
									'faces' => $hs_typography_mixed_fonts )
							);
		...
		$options['h4_heading'] = array( 'name' => 'H4 Heading',
							...
							'id' => 'h4_heading',
							'std' => array( 'size' => '24px', 'lineheight' => '28px', 'face' => 'Oswald', 'style' => 'normal', 'weight' => '500', 'character'  => 'latin', 'color' => '#222222'),
							'type' => 'typography',
							'options' => array(
									'faces' => $hs_typography_mixed_fonts )
							);
		...
		$options['h5_heading'] = array( 'name' => 'H5 Heading',
							...
							'id' => 'h5_heading',
							'std' => array( 'size' => '21px', 'lineheight' => '32px', 'face' => 'Oswald', 'style' => 'normal', 'weight' => '200', 'character'  => 'latin', 'color' => '#222222'),
							'type' => 'typography',
							'options' => array(
									'faces' => $hs_typography_mixed_fonts )
							);
...
$options[] = array( "name" => "Custom CSS",
		...
		$options['private_photo'] = array( "name" => "Private photo Path",
							"desc" => "Click Upload or Enter the direct path to your <strong>private photo</strong>.",
							"id" => "private_photo",
							"std" => "",
							"type" => "upload");	

		$options[] = array( "name" => "Blog Founder",
							"desc" => "Enter name of the blog founder.",
							"id" => "blog_founder",
							"std" => "John Doe",
							"type" => "text");	

		$options[] = array( "name" => "Founder position",
...
$options['email_share'] = array( "name" => "Enable Email sharing for blog posts?",
		...
		$options[] = array( 'name' => 'Footer Menu Typography',
							...
							'std' => array( 'size' => '13px', 'lineheight' => '22px', 'face' => 'Open Sans', 'style' => 'normal', 'weight' => '400', 'character'  => 'latin', 'color' => '#667078'),
							'type' => 'typography',
							'options' => array(
									'faces' => $hs_typography_mixed_fonts )
							);
