...
.main-holder, .mfp-wrap { font-weight: 300; font-style: normal; font-size: 20px; line-height: 31px; font-family: Open Sans; color:#525252; }
...
.nav.footer-nav a { font-weight: 400; font-style: normal; font-size: 13px; line-height: 22px; font-family: Open Sans; color:#667078; }</style>\n";
	echo $output;
	 }
}
